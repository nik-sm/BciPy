...
def test_pipeline():
    ...
    for gam in [0, 0.3, 0.6, 0.9]:
        for lam in [0, 0.3, 0.6, 0.9]:
            # TODO - this manual adjustment of attributes of the model is bad - this should be a method call
            ...
            breakpoint()
            # TODO - ???
            # - predict method does not exist anywhere.
            # - why are we accessing a subset of the pipeline
            # - no part of the pipeline returns a scalar, so what will we possibly contour plot here
